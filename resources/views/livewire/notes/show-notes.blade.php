    ...
    <div class="space-y-2">
        @if($notes->isEmpty())
            <div class="text-center">
                ...
                <x-button primary icon-right class="mt-6" href="{{ route('notes.create') }}" wire-navigate>Create note</x-button>
            </div>
        @else
        <x-button primary icon-right class="mt-6 mb-6" href="{{ route('notes.create') }}" wire-navigate>Create note</x-button>
